# iblg_matplotlib_tools

Here is a quick tutorial on how to locally install the package.

## How to install `iblg_matplotlib_tools` locally

`cd` into the project directory:

```bash
cd iblg_matplotlib_tools
```

Create and activate a new conda environment:

```bash
conda create -n iblg_matplotlib_tools_env python=<max_python_version>
conda activate iblg_matplotlib_tools_env
```
